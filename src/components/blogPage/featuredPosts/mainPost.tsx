...
export default function MainPost({ img, date, author, title, description, tags,slug, }: Props) {
    return (
        <Stack as={Link} href={`blog/${slug}`} h={"fit-content"} w={["full","48%"]}  spacing={5}>
            <Image src={img} alt="blog-1" width={"full"} maxH={230}/>
