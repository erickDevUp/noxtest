...
export default function Ornaments() {
    return (
        <>
            ...
            <Image className="float-animation-ornament" objectFit={"scale-down"} src={"img/home/points1.svg"} alt={"ornament 2 hero nox"} position={"absolute"} left={[0, "-150px"]} zIndex={5} top={["-250px", "-100px"]} width={["100%", "auto"]} />
            <Image className="float-animation-ornament" display={["none", "block"]} objectFit={"scale-down"} src={"img/home/points2.svg"} alt={"ornament 3 hero nox"} position={"absolute"} right={"-180px"} zIndex={5} top={"-150px"} width={["100%", "auto"]} />
