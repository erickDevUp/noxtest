...
export default function Hero() {
    return (
        <Stack textAlign={"center"} py={[0, 10]} position={"relative"} maxW={985} gap={8} margin={"auto"} bgImage={"img/home/heroLogo.png"} bgSize={"auto"} bgRepeat={"no-repeat"} bgPosition={"top"} >
           <Ornaments />
            <Heading as={"h1"} fontSize={["2xl", 50]} lineHeight={["normal", "50px"]}>¿Quieres automatizar tu negocio y no sabes a quién acudir?</Heading>
